    ...
    <header class="header">
        ...
        <div class="sidebar">
                <div class="branch__div">
                    ...
                    <ul class = "branch">
                        <li class = "branch1">Sediu central: <a class="li_adres">Bd.Moscova,17/2</a></li>
            ...
            <div class="curs">
                <div class="container">
                    <div class="curs__items">
                        ...
                        <h1 class="curs__title">AXEMOL:  Sediu central</h1>
                        <p class="adres">Bd.Moscova,17/2</p>
                        <a class="btn  btn--gray" href="https://goo.gl/maps/hdAQCk7tEmpMwRYR9" target="_blank">adresa pe hartă</a>
                        <p class="update__date">Numar de telefon:  +373 672 89 302</p>
                        ...
                        <table class="main__container main__container1" id="first">
                            ...
                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("axemol","sediucentral","usd","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/united-states.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("axemol","sediucentral","usd","sell");?></p>
                                </td>
                            </tr>

                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("axemol","sediucentral","eur","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/eu-main-flag.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("axemol","sediucentral","eur","sell");?></p>
                                </td>
                            </tr>

                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("axemol","sediucentral","rub","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/russia-flag.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("axemol","sediucentral","rub","sell");?></p>
                                </td>
                            </tr>

                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("axemol","sediucentral","ron","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/romania-flag.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("axemol","sediucentral","ron","sell");?></p>
                                </td>
                            </tr>

                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("axemol","sediucentral","uah","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/ukraine-flag.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("axemol","sediucentral","uah","sell");?></p>
                                </td>
                            </tr>

                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("axemol","sediucentral","gbp","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/united-kingdom.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("axemol","sediucentral","gbp","sell");?></p>
                                </td>
                            </tr>
