    ...
    <header class="header">
        ...
        <div class="sidebar">
                <div class="branch__div">
                    ...
                    <ul class = "branch">
                        <li class = "branch1">Sediu central: <a class="li_adres">Str.N.Zelinski,7</a></li>
                        <li class = "branch2 ">Sucursala Nr.1: <a class="li_adres">Bd.Dacia,44</a></li>
                        <li class = "branch3 ">Sucursala Nr.2: <a class="li_adres">Str.Trandafirilor,13/1</a></li>
                    </ul>
            ...
            <div class="curs">
                <div class="container">
                    <div class="curs__items">
                        ...
                        <h1 class="curs__title">MAXBEMOL:  Sediu central</h1>
                        <p class="adres">Str.N.Zelinski,7</p>
                        <a class="btn  btn--gray" href="https://goo.gl/maps/hdAQCk7tEmpMwRYR9" target="_blank">adresa pe hartă</a>
                        <p class="update__date">Numar de telefon:  +373 672 89 306</p>
                        ...
                        <table class="main__container main__container1" id="first">
                            ...
                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("maxbemol","sediucentral","usd","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/united-states.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("maxbemol","sediucentral","usd","sell");?></p>
                                </td>
                            </tr>

                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("maxbemol","sediucentral","eur","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/eu-main-flag.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("maxbemol","sediucentral","eur","sell");?></p>
                                </td>
                            </tr>

                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("maxbemol","sediucentral","rub","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/russia-flag.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("maxbemol","sediucentral","rub","sell");?></p>
                                </td>
                            </tr>

                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("maxbemol","sediucentral","ron","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/romania-flag.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("maxbemol","sediucentral","ron","sell");?></p>
                                </td>
                            </tr>

                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("maxbemol","sediucentral","uah","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/ukraine-flag.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("maxbemol","sediucentral","uah","sell");?></p>
                                </td>
                            </tr>

                            <tr class="currencies">
                                <td>
                                    <p class="block"><?php echo get_num("maxbemol","sediucentral","gbp","buy");?></p>
                                </td>
                                <td><img src="./assets/icons/united-kingdom.png" alt="" class="icon"></td>
                                <td>
                                    <p class="block2"><?php echo get_num("maxbemol","sediucentral","gbp","sell");?></p>
                                </td>
                            </tr>
            ...
            <div class="curs">
                <div class="container">
                    <div class="curs__items">
                        ...
                        <h1 class="curs__title">MAXBEMOL:  Sucursala Nr.1</h1>
                        <p class="adres">Bd.Dacia,44</p>
                        <a class="btn  btn--gray" href="https://goo.gl/maps/hdAQCk7tEmpMwRYR9" target="_blank">adresa pe hartă</a>
                        <p class="update__date">Numar de telefon:  +373 672 89 303</p>
            ...
            <div class="curs">
                <div class="container">
                    <div class="curs__items">
                        ...
                        <h1 class="curs__title">MAXBEMOL:  Sucursala Nr.2</h1>
                        <p class="adres">Str.Trandafirilor,13/1</p>
                        <a class="btn  btn--gray" href="https://goo.gl/maps/hdAQCk7tEmpMwRYR9" target="_blank">adresa pe hartă</a>
                        <p class="update__date">Numar de telefon:  +373 677 89 308</p>
